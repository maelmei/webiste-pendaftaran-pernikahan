...
<div class="container" style="margin-top: 100px; margin-bottom:100px;">
    ...
    <a href="/exportUser" class="btn btn-warning mb-3 fw-bold">Export Data</a>
            ...
            <table id="table_id" class="display">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="/ban-user/{{ $item->id }}/" class="btn btn-warning fw-bold">Banned</a><br>
                                <a href="/unban/{{ $item->id }}" class="btn btn-success mt-3 fw-bold">UnBanned</a>
